 ...
 */
function(t,e){"function"==typeof define&&define.amd?define(["flickity/js/index","imagesloaded/imagesloaded"],(function(i,n){return e(t,i,n)})):"object"==typeof module&&module.exports?module.exports=e(t,require("flickity"),require("imagesloaded")):t.Flickity=e(t,t.Flickity,t.imagesLoaded)}(window,(function(t,e,i){"use strict";e.createMethods.push("_createImagesLoaded");var n=e.prototype;return n._createImagesLoaded=function(){this.on("activate",this.imagesLoaded)},n.imagesLoaded=function(){if(this.options.imagesLoaded){var t=this;i(this.slider).on("progress",(function(e,i){var n=t.getParentCell(i.img);t.cellSizeChange(n&&n.element),t.options.freeScroll||t.positionSliderAtSelected()}))}},e}));const menuBtn=document.querySelector(".menu-btn"),nav=document.querySelector(".navigation"),menuOverlay=document.querySelector(".nav-overlay"),carousels=document.querySelectorAll(".main-carousel"),actualSlideDOM=document.querySelector(".acutalSlide"),totalSlidesDOM=document.querySelector(".totalSlides");let slideCounter=document.querySelector(".slides-counter");const mainCarousel=document.querySelector(".main-carousel"),infoButton=document.querySelector(".project-toggle button"),header=document.querySelector(".fixed-container"),infoContent=document.querySelector(".project-text");let touchDevice=!1;const customCursor=document.querySelector("#besideMouse"),cursorText=document.querySelector("#besideMouse p");let buttonPrev,buttonNext,menuIsOpen;function resetHeight(){let t=window.innerHeight+"px",e=document.documentElement,i=header?.getBoundingClientRect().bottom.toFixed(),n=window.innerWidth/2*2.78+"px",s=window.innerHeight-i-14-14+"px";const o=document.querySelector(".project-text p")?.offsetHeight+"px";document.querySelector("body").style.height=t,e.style.setProperty("--viewport-height",t),e.style.setProperty("--max-height-img",s),e.style.setProperty("--min-height-img",n),e.style.setProperty("--project-text-height",o)}window.onload=()=>{customCursor.style.opacity=0,customCursor.style.display=touchDevice?"none":"block"},touchDevice="ontouchstart"in document.documentElement,window.addEventListener("resize",(function(){resetHeight()})),resetHeight(),nav?.classList.contains("menu-open");const showMenu=()=>{menuIsOpen?(nav.classList.remove("menu-open"),document.body.classList.remove("body-overflow")):(nav.classList.add("menu-open"),document.body.classList.add("body-overflow")),menuIsOpen=!menuIsOpen},mobileMenuVisible=()=>{const t=document.querySelector(".menu-btn");if(null!==t){return"none"==window.getComputedStyle(t).getPropertyValue("display")?(nav.classList.remove("mobile-menu"),!1):(nav.classList.add("mobile-menu"),!0)}};mobileMenuVisible(),menuBtn&&menuBtn.addEventListener("click",showMenu),menuOverlay&&menuOverlay.addEventListener("click",showMenu);for(let t of carousels){new Flickity(t,{lazyLoad:2,pageDots:!1,wrapAround:!1,dragThreshold:0,selectedAttraction:.1,friction:1,on:{ready:function(){totalSlidesDOM.innerHTML=this.cells.length-1,buttonPrev=document.querySelector(".flickity-button.previous"),buttonNext=document.querySelector(".flickity-button.next"),buttonNext.style.width="100%"},change:function(t){const e=document.querySelectorAll(".hideOnLastSlide");t<this.cells.length-1?(actualSlideDOM.innerHTML=t+1,Array.from(e,(t=>t.style.opacity=1)),infoContent.style.visibility="visible",document.querySelector(".index-btn").style.visibility="hidden",document.querySelector(".index-btn").style.opacity=0,t>0?(buttonNext.style.width="50%",buttonPrev.style.width="50%"):0==t&&(buttonNext.style.width="100%")):t==this.cells.length-1&&(Array.from(e,(t=>t.style.opacity=0)),buttonPrev.style.width="100%",infoContent.style.visibility="hidden",document.querySelector(".index-btn").style.visibility="visible",document.querySelector(".index-btn").style.opacity=1),player.pause()},settle:function(t){document.onmouseover=t=>changeTextOnCursor(t)}}});const e=document.querySelector(".flickity-slider");e.style.pointerEvents=touchDevice?"auto":"none"}!function(){var t,e=!1;document.body.addEventListener("touchstart",(function(i){i.target.closest(".flickity-slider")?(e=!0,t={x:i.touches[0].pageX,y:i.touches[0].pageY}):e=!1})),document.body.addEventListener("touchmove",(function(i){if(e&&i.cancelable){var n={x:i.touches[0].pageX-t.x,y:i.touches[0].pageY-t.y};Math.abs(n.x)>7&&i.preventDefault()}}),{passive:!1})}(),window.onresize=()=>{mobileMenuVisible()},infoButton&&(infoButton.onclick=function(){infoContent.classList.contains("show-description")?(infoContent.classList.remove("show-description"),infoButton.innerHTML="info"):(infoContent.classList.add("show-description"),infoButton.innerHTML="close")});const links=document.querySelectorAll(".fixed-container a"),buttons=document.querySelectorAll(".fixed-container button"),clickableElements=[...links,...buttons],cursorSymbol=customCursor.querySelector(".cursorSymbol");function changeTextOnCursor(t){if(t.target==buttonPrev)cursorText.innerText="Prev",cursorText.style.opacity=1,cursorSymbol.style.opacity=0;else if(t.target==buttonNext)cursorText.innerText="Next",cursorText.style.opacity=1,cursorSymbol.style.opacity=0;else if(t.target!==buttonNext||buttonPrev)return cursorText.style.opacity=0,void(cursorSymbol.style.opacity=1)}document.onmousemove=t=>{customCursor.style.opacity=1,changeTextOnCursor(t);let e=t.clientX,i=t.clientY,n=window.scrollX,s=window.scrollY;customCursor.style.transform=`translate(${e+n+"px"}, ${i+s+"px"})`;for(let e of[...clickableElements]){if(e==t.target)return void(cursorSymbol.style.transform="scale(1.8)");e!==t.target&&(cursorSymbol.style.transform="scale(1)")}};